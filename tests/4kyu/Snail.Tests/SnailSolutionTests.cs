...
public class SnailSolutionTests
{
    ...
    /// <summary>
    /// Vérifie le comportement avec une matrice 1x1.
    /// </summary>
    [Test]
    [Order(3)]
    ...
    /// <summary>
    /// Vérifie le comportement avec une matrice contenant une ligne vide.
    /// </summary>
    [Test]
    [Order(5)]
    ...
    /// <summary>
    /// Convertit une matrice en représentation textuelle lisible.
    /// </summary>
    /// <param name="array">Matrice à convertir.</param>
    /// <returns>Chaîne représentant la matrice.</returns>
    ...
    /// <summary>
    /// Vérifie que le résultat retourné correspond au résultat attendu.
    /// </summary>
